...
public class Demo2Ios {
	...
	AutomationTestForm2  form;
	AutomationTestForm3  form1;
	SyncPageBlank  sync;
	...
	public void Test01() {
		try {
		    ...
		    form=new 	AutomationTestForm2(manager.getDriver(), config.getPlatform());
		    ...
		    catPage.selectCategoryListView("test",config);
		  	Thread.sleep(2000);
		        ...
		        formList.selectForm("camera",config);
		        Thread.sleep(3000);
		   
	            form.fillForm1(config);
	            form.scrollToTextIos("Label");
	    		form.submit();
	...
	public void Test02() {
		try {
			shell=new ShellPage(manager.getDriver(), config.getPlatform());
			form1=new AutomationTestForm3(manager.getDriver(), config.getPlatform());
		    drafts=new  DraftsPage(manager.getDriver(), config.getPlatform());
	        ...
	        formList.selectForm("gallery",config);
	        Thread.sleep(3000);
	     	form1.takescreenshot1();
            form1.fillForm1(config);
        	Thread.sleep(5000);
        	form1.annotation1(config);
        	Thread.sleep(5000);
