...
public class NotificationsPage extends BasePage {
	...
	public void Remove(String linearLayoutIndex,DriverConfig config) {
		...
		String platformVersion=config.getPlatformVersion();
		 ...
		 remove=findElementByXpath("//android.widget.LinearLayout[@index='" +linearLayoutIndex+"']" + "/android.view.ViewGroup[@index='0']/android.view.ViewGroup[@index='0']/android.view.ViewGroup[@index='0']/android.view.ViewGroup[@index='2']/android.view.ViewGroup[@index='0']");
